...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OCIImageClaim)(nil), (*ignite.OCIImageClaim)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_OCIImageClaim_To_ignite_OCIImageClaim(a.(*OCIImageClaim), b.(*ignite.OCIImageClaim), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*ignite.OCIImageClaim)(nil), (*OCIImageClaim)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_ignite_OCIImageClaim_To_v1alpha2_OCIImageClaim(a.(*ignite.OCIImageClaim), b.(*OCIImageClaim), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ImageSpec_To_ignite_ImageSpec(in *ImageSpec, out *ignite.ImageSpec, s conversion.Scope) error {
	if err := Convert_v1alpha2_OCIImageClaim_To_ignite_OCIImageClaim(&in.OCIClaim, &out.OCIClaim, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_ignite_ImageSpec_To_v1alpha2_ImageSpec(in *ignite.ImageSpec, out *ImageSpec, s conversion.Scope) error {
	if err := Convert_ignite_OCIImageClaim_To_v1alpha2_OCIImageClaim(&in.OCIClaim, &out.OCIClaim, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha2_OCIImageClaim_To_ignite_OCIImageClaim(in *OCIImageClaim, out *ignite.OCIImageClaim, s conversion.Scope) error {
	out.Type = ignite.ImageSourceType(in.Type)
	out.Ref = v1alpha1.OCIImageRef(in.Ref)
	return nil
}

// Convert_v1alpha2_OCIImageClaim_To_ignite_OCIImageClaim is an autogenerated conversion function.
func Convert_v1alpha2_OCIImageClaim_To_ignite_OCIImageClaim(in *OCIImageClaim, out *ignite.OCIImageClaim, s conversion.Scope) error {
	return autoConvert_v1alpha2_OCIImageClaim_To_ignite_OCIImageClaim(in, out, s)
}

func autoConvert_ignite_OCIImageClaim_To_v1alpha2_OCIImageClaim(in *ignite.OCIImageClaim, out *OCIImageClaim, s conversion.Scope) error {
	out.Type = ImageSourceType(in.Type)
	out.Ref = v1alpha1.OCIImageRef(in.Ref)
	return nil
}

// Convert_ignite_OCIImageClaim_To_v1alpha2_OCIImageClaim is an autogenerated conversion function.
func Convert_ignite_OCIImageClaim_To_v1alpha2_OCIImageClaim(in *ignite.OCIImageClaim, out *OCIImageClaim, s conversion.Scope) error {
	return autoConvert_ignite_OCIImageClaim_To_v1alpha2_OCIImageClaim(in, out, s)
}
